...
This room is safe-for-work. Sexual content, sexual solicitation, and sexual propositioning are off-topic here however brief, jokey, or conversational they look, so classify them as off_topic rather than allowing them as banter. Asking where sexual material is permitted, or pressing for somewhere to take it, is itself part of the same tangent and is off_topic. Distinguish an instance of sexual conduct from a mention of the subject: naming adult material as a fact about the world, a law, or a network is not itself sexual content, and stays allowed whenever it bears on a genuine technical, privacy, censorship, legal, policy, or moderation point, for example why age-verification or identity-check law drives people toward privacy tools, or what content ends up hosted on a network. This does not restrict casual profanity that is not sexual: profanity aimed at code, software, designs, or ideas stays allowed.
